      ...
      <div style={{ height: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: '24px', height: '100%', alignItems: 'stretch' }}>
          ...
          <aside className="no-scrollbar" style={{ position: 'sticky', top: 0, alignSelf: 'start', display: 'flex', flexDirection: 'column', gap: '14px', maxHeight: 'calc(100vh - 100px)', overflowY: 'auto', paddingBottom: '24px' }}>
            <div className="sc-card-animated" style={{ background: 'linear-gradient(135deg, #4A2530, #6B3744)', border: 'none', borderRadius: '18px', overflow: 'hidden', boxShadow: 'var(--shadow)', display: 'flex', flexDirection: 'column', maxHeight: '420px', animationDelay: '0.1s', color: '#ffffff' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '14px 16px 12px', borderBottom: '1px solid rgba(255, 255, 255, 0.15)' }}>
                ...
                <Link to="/schedule" style={{ fontSize: '12px', color: '#ffccd5', textDecoration: 'none', fontWeight: 700 }}>Tất cả</Link>
              </div>
              ...
              <div style={{ padding: '10px 16px 6px' }}>
                <div style={{ fontSize: '11px', fontWeight: 700, color: 'rgba(255, 255, 255, 0.85)', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: '6px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                ...
                {schedules.length === 0 ? (
                  <div style={{ padding: '10px 0 8px', textAlign: 'center', color: 'rgba(255, 255, 255, 0.6)', fontSize: '12px' }}>
                      ...
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ fontSize: '11px', color: 'rgba(255, 255, 255, 0.6)', marginTop: '2px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                            <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, color: 'rgba(255, 255, 255, 0.6)' }}>
              ...
              <div style={{ padding: '10px 16px 14px' }}>
                ...
                {deadlines.length === 0 ? (
                  <div style={{ padding: '10px 0', textAlign: 'center', color: 'rgba(255, 255, 255, 0.6)', fontSize: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '4px' }}>
                  ...
                  deadlines.map((d) => (
                    <Link key={d.id} to={`/groups/${d.groupId}?tab=deadlines`} style={{ textDecoration: 'none', color: 'inherit', display: 'block' }}>
                      ...
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <div style={{ fontSize: '12px', fontWeight: 600, color: d.overdue ? 'rgba(255, 255, 255, 0.5)' : '#ffffff', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{d.title}</div>
            ...
            {/* ── Bạn bè trực tuyến ── */}
            <div className="sc-card-animated" style={{ background: 'linear-gradient(135deg, #4A2530, #6B3744)', border: 'none', borderRadius: '18px', overflow: 'hidden', boxShadow: 'var(--shadow)', animationDelay: '0.15s', color: '#ffffff' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '14px 16px 12px', borderBottom: '1px solid rgba(255, 255, 255, 0.15)' }}>
                <span style={{ fontWeight: 700, fontSize: '14px', display: 'flex', alignItems: 'center', gap: '8px', color: '#ffffff' }}>
                ...
                <Link to="/friends" style={{ fontSize: '12px', color: '#ffccd5', textDecoration: 'none', fontWeight: 700 }}>Tất cả</Link>
              </div>
              ...
              <div style={{
                ...
                {friends.length === 0 ? (
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '12px 0', textAlign: 'center', color: 'rgba(255, 255, 255, 0.6)', fontSize: '12px' }}>
                    <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="rgba(255, 255, 255, 0.6)" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: '10px', opacity: 0.55 }}>
                      <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" />
                      <circle cx="9" cy="7" r="4" />
                      <line x1="17" y1="8" x2="21" y2="12" />
                      <line x1="21" y1="8" x2="17" y2="12" />
                    </svg>
                    <span style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Chưa có bạn bè nào. <Link to="/friends" style={{ color: '#ffccd5', fontWeight: 600 }}>Kết bạn ngay</Link></span>
                  </div>
                ) : (() => {
                  ...
                  if (onlineFriends.length === 0) {
                    return (
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '12px 0', textAlign: 'center', color: 'rgba(255, 255, 255, 0.6)', fontSize: '12px' }}>
                        ...
                        <span style={{ color: 'rgba(255, 255, 255, 0.8)' }}>Chưa có bạn bè nào trực tuyến.</span>
                      </div>
                    );
                  }
