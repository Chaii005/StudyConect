        ...
        <div className="meet-body" style={{ flex: 1, display: 'flex', overflow: 'hidden', height: '100%', position: 'relative' }}>
          ...
          {!isFullscreen && sidebarOpen && (
            <div className="meet-sidebar" style={{
              ...
              {/* Header với Segmented Control cực kỳ cao cấp */}
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <h3 style={{ margin: 0, fontSize: '15px', fontWeight: 800, color: '#171717', letterSpacing: '-0.02em', textTransform: 'uppercase' }}>
                    {tab === 'chat' ? 'Trò chuyện nhóm' : tab === 'timer' ? 'Đồng hồ Pomodoro' : 'Thành viên phòng'}
                  </h3>
                  <span style={{
                    fontSize: '11px',
                    background: '#f4f4f5',
                    ...
                    {tab === 'chat' ? 'Realtime' : tab === 'timer' ? 'Tập trung' : `${allFeeds.length} Online`}
                  </span>
                </div>
